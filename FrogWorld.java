...
public class FrogWorld extends World
{
    ...
    public void addCars()
    {
        ...
        addObject ( new Car (5), 750, 450);
        addObject ( new Car (5), 300, 450);
        //second row of Cars, all y = 390, speed of 5
        addObject ( new Car (5), 200, 390);
        addObject ( new Car (5), 541, 390);
        //third row of Cars, all y = 330, speed of 7
        addObject ( new Car (7), 584, 330);
    ...
    public void addTrucks()
    {
        ...
        addObject ( new Truck (-8), 610, 210);
        addObject ( new Truck (-8), 300, 210);
        //second row of Trucks, all y = 150, speed of -8
        addObject ( new Truck (-8), 550, 150);
        addObject ( new Truck (-8), 50, 150);
        //third row of Trucks, all y = 90, speed of 10
        addObject ( new Truck (-10), 730, 90);
        addObject ( new Truck (-10), 350, 90);
    }
}
